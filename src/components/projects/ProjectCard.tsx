  ...
  return (
    <Card className="group h-full w-full overflow-hidden transition-all p-0 border-gray-100 dark:border-gray-800 shadow-none">
      <div className="flex flex-col md:flex-row">
        {/* Image - Left Side */}
        <div className="flex-shrink-0 w-24 ml-4 mt-4 md:w-32 md:mt-4 md:ml-4">
          <div className="group relative w-full aspect-square overflow-hidden rounded-xl border border-gray-100 dark:border-gray-800">
            <Image
        ...
        <div className="flex-1 flex flex-col">
          ...
          {project.details && (
            <CardFooter className="px-6 py-4 flex justify-between border-t border-gray-100 dark:border-gray-800">
              <div
